...
CREATE OR REPLACE FUNCTION "public"."ensure_user_match"("p_user_a" "uuid", "p_user_b" "uuid") RETURNS "uuid"
...
ALTER FUNCTION "public"."ensure_user_match"("p_user_a" "uuid", "p_user_b" "uuid") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."dogs" (
    ...
    "walking_locations" "text"[] DEFAULT '{}'::"text"[],
    "walking_times" "text"[] DEFAULT '{}'::"text"[],
    "walking_frequency" "text" DEFAULT ''::"text",
    "walking_spots" "text"[] DEFAULT '{}'::"text"[]
);
...
CREATE OR REPLACE FUNCTION "public"."get_nearby_dogs"("user_lat" double precision, "user_lng" double precision, "radius_km" double precision) RETURNS SETOF "public"."dogs"
...
ALTER FUNCTION "public"."get_nearby_dogs"("user_lat" double precision, "user_lng" double precision, "radius_km" double precision) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_upcoming_health_reminders"("p_user_id" "uuid", "p_within_days" integer DEFAULT 30) RETURNS TABLE("record_id" "uuid", "dog_id" "uuid", "dog_name" "text", "type_code" "text", "type_label" "text", "title" "text", "next_due_at" "date", "days_until" integer)
...
ALTER FUNCTION "public"."get_upcoming_health_reminders"("p_user_id" "uuid", "p_within_days" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."matches_ensure_user_match"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  v_owner_a UUID;
...
ALTER FUNCTION "public"."matches_ensure_user_match"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."messages_fill_user_match_id"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  v_owner_a UUID;
...
ALTER FUNCTION "public"."messages_fill_user_match_id"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_user_location_by_id"("user_id" "uuid", "lat" double precision, "lng" double precision) RETURNS "void"
    LANGUAGE "sql" SECURITY DEFINER
    AS $$
  UPDATE profiles
...
ALTER FUNCTION "public"."update_user_location_by_id"("user_id" "uuid", "lat" double precision, "lng" double precision) OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."dog_expenses" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    ...
    CONSTRAINT "dog_expenses_amount_check" CHECK (("amount" >= (0)::numeric))
);


ALTER TABLE "public"."dog_expenses" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."dog_genders" (
    "code" "text" NOT NULL,
    "label" "text" NOT NULL,
...
ALTER TABLE "public"."dog_genders" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."dog_sizes" (
    "code" "text" NOT NULL,
    "label" "text" NOT NULL,
    "sort_order" integer DEFAULT 0 NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL
...
ALTER TABLE "public"."dog_sizes" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."expense_categories" (
    ...
    "sort_order" integer DEFAULT 0 NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "expense_categories_owner_consistency" CHECK (((("is_system" = true) AND ("created_by_user_id" IS NULL)) OR (("is_system" = false) AND ("created_by_user_id" IS NOT NULL))))
);
...
CREATE TABLE IF NOT EXISTS "public"."expense_contributors" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "expense_contributors_amount_owed_check" CHECK (("amount_owed" >= (0)::numeric)),
    CONSTRAINT "expense_contributors_amount_paid_check" CHECK (("amount_paid" >= (0)::numeric))
);


ALTER TABLE "public"."expense_contributors" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."expense_pets" (
    ...
    "share_ratio" numeric(6,4) DEFAULT 1.0 NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "expense_pets_share_ratio_check" CHECK ((("share_ratio" > (0)::numeric) AND ("share_ratio" <= (1)::numeric)))
);


ALTER TABLE "public"."expense_pets" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."health_record_types" (
    "code" "text" NOT NULL,
    "label" "text" NOT NULL,
    "unit" "text",
    "icon" "text",
...
ALTER TABLE "public"."health_record_types" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."swipes" (
    ...
    "swiped_dog_id" "uuid" NOT NULL,
    "direction" "text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "swipes_direction_check" CHECK (("direction" = ANY (ARRAY['like'::"text", 'pass'::"text"])))
);
...
ALTER TABLE "public"."walk_group_members" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."walk_group_messages" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "group_id" "uuid" NOT NULL,
    "sender_id" "uuid" NOT NULL,
    "content" "text" NOT NULL,
...
ALTER TABLE "public"."walk_group_messages" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."walk_groups" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "creator_id" "uuid" NOT NULL,
    "creator_dog_id" "uuid" NOT NULL,
    "title" "text" NOT NULL,
...
ALTER TABLE "public"."walk_groups" OWNER TO "postgres";


ALTER TABLE ONLY "public"."dog_expenses"
    ADD CONSTRAINT "dog_expenses_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."dog_genders"
    ADD CONSTRAINT "dog_genders_pkey" PRIMARY KEY ("code");



ALTER TABLE ONLY "public"."dog_sizes"
    ADD CONSTRAINT "dog_sizes_pkey" PRIMARY KEY ("code");
...
ALTER TABLE ONLY "public"."expense_contributors"
    ADD CONSTRAINT "expense_contributors_expense_id_user_id_key" UNIQUE ("expense_id", "user_id");



ALTER TABLE ONLY "public"."expense_contributors"
    ADD CONSTRAINT "expense_contributors_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."expense_pets"
    ADD CONSTRAINT "expense_pets_expense_id_dog_id_key" UNIQUE ("expense_id", "dog_id");



ALTER TABLE ONLY "public"."expense_pets"
    ADD CONSTRAINT "expense_pets_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."health_record_types"
    ADD CONSTRAINT "health_record_types_pkey" PRIMARY KEY ("code");
...
ALTER TABLE ONLY "public"."swipes"
    ADD CONSTRAINT "swipes_swiper_dog_id_swiped_dog_id_key" UNIQUE ("swiper_dog_id", "swiped_dog_id");
...
ALTER TABLE ONLY "public"."user_matches"
    ADD CONSTRAINT "user_matches_unique_pair" UNIQUE ("user_a_id", "user_b_id");



ALTER TABLE ONLY "public"."walk_group_members"
    ADD CONSTRAINT "walk_group_members_group_id_dog_id_key" UNIQUE ("group_id", "dog_id");



ALTER TABLE ONLY "public"."walk_group_members"
    ADD CONSTRAINT "walk_group_members_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."walk_group_messages"
    ADD CONSTRAINT "walk_group_messages_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."walk_groups"
    ADD CONSTRAINT "walk_groups_pkey" PRIMARY KEY ("id");



CREATE INDEX "idx_dog_expenses_category" ON "public"."dog_expenses" USING "btree" ("category_id");



CREATE INDEX "idx_dog_expenses_payer" ON "public"."dog_expenses" USING "btree" ("paid_by_user_id");



CREATE INDEX "idx_dog_expenses_spent_at" ON "public"."dog_expenses" USING "btree" ("spent_at" DESC);



CREATE INDEX "idx_dogs_active" ON "public"."dogs" USING "btree" ("is_active") WHERE ("is_active" = true);



CREATE INDEX "idx_dogs_owner" ON "public"."dogs" USING "btree" ("owner_id");



CREATE INDEX "idx_expense_categories_owner" ON "public"."expense_categories" USING "btree" ("created_by_user_id") WHERE ("created_by_user_id" IS NOT NULL);



CREATE INDEX "idx_expense_contributors_expense" ON "public"."expense_contributors" USING "btree" ("expense_id");



CREATE INDEX "idx_expense_contributors_user" ON "public"."expense_contributors" USING "btree" ("user_id");



CREATE INDEX "idx_expense_pets_dog" ON "public"."expense_pets" USING "btree" ("dog_id");



CREATE INDEX "idx_expense_pets_expense" ON "public"."expense_pets" USING "btree" ("expense_id");



CREATE INDEX "idx_health_records_dog" ON "public"."health_records" USING "btree" ("dog_id");



CREATE INDEX "idx_health_records_next_due" ON "public"."health_records" USING "btree" ("next_due_at") WHERE ("next_due_at" IS NOT NULL);



CREATE INDEX "idx_health_records_recorded" ON "public"."health_records" USING "btree" ("dog_id", "recorded_at" DESC);



CREATE INDEX "idx_health_records_type" ON "public"."health_records" USING "btree" ("type_code");



CREATE INDEX "idx_matches_dog_a" ON "public"."matches" USING "btree" ("dog_a_id");



CREATE INDEX "idx_matches_dog_b" ON "public"."matches" USING "btree" ("dog_b_id");
...
CREATE INDEX "idx_messages_user_match" ON "public"."messages" USING "btree" ("user_match_id");
...
CREATE INDEX "idx_swipes_swiped" ON "public"."swipes" USING "btree" ("swiped_dog_id");



CREATE INDEX "idx_swipes_swiper" ON "public"."swipes" USING "btree" ("swiper_dog_id");



CREATE INDEX "idx_user_matches_user_a" ON "public"."user_matches" USING "btree" ("user_a_id");



CREATE INDEX "idx_user_matches_user_b" ON "public"."user_matches" USING "btree" ("user_b_id");



CREATE OR REPLACE TRIGGER "trg_dog_expenses_touch" BEFORE UPDATE ON "public"."dog_expenses" FOR EACH ROW EXECUTE FUNCTION "public"."touch_updated_at"();



CREATE OR REPLACE TRIGGER "trg_expense_contributors_touch" BEFORE UPDATE ON "public"."expense_contributors" FOR EACH ROW EXECUTE FUNCTION "public"."touch_updated_at"();



CREATE OR REPLACE TRIGGER "trg_health_records_touch" BEFORE UPDATE ON "public"."health_records" FOR EACH ROW EXECUTE FUNCTION "public"."touch_updated_at"();



CREATE OR REPLACE TRIGGER "trg_matches_ensure_user_match" AFTER INSERT ON "public"."matches" FOR EACH ROW EXECUTE FUNCTION "public"."matches_ensure_user_match"();



CREATE OR REPLACE TRIGGER "trg_messages_fill_user_match" BEFORE INSERT ON "public"."messages" FOR EACH ROW EXECUTE FUNCTION "public"."messages_fill_user_match_id"();



ALTER TABLE ONLY "public"."dog_expenses"
    ADD CONSTRAINT "dog_expenses_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "public"."expense_categories"("id");



ALTER TABLE ONLY "public"."dog_expenses"
    ADD CONSTRAINT "dog_expenses_paid_by_user_id_fkey" FOREIGN KEY ("paid_by_user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."dogs"
    ADD CONSTRAINT "dogs_gender_fkey" FOREIGN KEY ("gender") REFERENCES "public"."dog_genders"("code");
...
ALTER TABLE ONLY "public"."dogs"
    ADD CONSTRAINT "dogs_size_fkey" FOREIGN KEY ("size") REFERENCES "public"."dog_sizes"("code");



ALTER TABLE ONLY "public"."expense_categories"
    ADD CONSTRAINT "expense_categories_created_by_user_id_fkey" FOREIGN KEY ("created_by_user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."expense_contributors"
    ADD CONSTRAINT "expense_contributors_expense_id_fkey" FOREIGN KEY ("expense_id") REFERENCES "public"."dog_expenses"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."expense_contributors"
    ADD CONSTRAINT "expense_contributors_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."expense_pets"
    ADD CONSTRAINT "expense_pets_dog_id_fkey" FOREIGN KEY ("dog_id") REFERENCES "public"."dogs"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."expense_pets"
    ADD CONSTRAINT "expense_pets_expense_id_fkey" FOREIGN KEY ("expense_id") REFERENCES "public"."dog_expenses"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."health_records"
    ADD CONSTRAINT "health_records_dog_id_fkey" FOREIGN KEY ("dog_id") REFERENCES "public"."dogs"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."health_records"
    ADD CONSTRAINT "health_records_recorded_by_user_id_fkey" FOREIGN KEY ("recorded_by_user_id") REFERENCES "public"."profiles"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."health_records"
    ADD CONSTRAINT "health_records_type_code_fkey" FOREIGN KEY ("type_code") REFERENCES "public"."health_record_types"("code");



ALTER TABLE ONLY "public"."matches"
    ADD CONSTRAINT "matches_dog_a_id_fkey" FOREIGN KEY ("dog_a_id") REFERENCES "public"."dogs"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."matches"
    ADD CONSTRAINT "matches_dog_b_id_fkey" FOREIGN KEY ("dog_b_id") REFERENCES "public"."dogs"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."messages"
    ADD CONSTRAINT "messages_user_match_id_fkey" FOREIGN KEY ("user_match_id") REFERENCES "public"."user_matches"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."swipes"
    ADD CONSTRAINT "swipes_swiped_dog_id_fkey" FOREIGN KEY ("swiped_dog_id") REFERENCES "public"."dogs"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."swipes"
    ADD CONSTRAINT "swipes_swiper_dog_id_fkey" FOREIGN KEY ("swiper_dog_id") REFERENCES "public"."dogs"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."user_matches"
    ADD CONSTRAINT "user_matches_user_a_id_fkey" FOREIGN KEY ("user_a_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."user_matches"
    ADD CONSTRAINT "user_matches_user_b_id_fkey" FOREIGN KEY ("user_b_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."walk_group_members"
    ADD CONSTRAINT "walk_group_members_dog_id_fkey" FOREIGN KEY ("dog_id") REFERENCES "public"."dogs"("id");



ALTER TABLE ONLY "public"."walk_group_members"
    ADD CONSTRAINT "walk_group_members_group_id_fkey" FOREIGN KEY ("group_id") REFERENCES "public"."walk_groups"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."walk_group_members"
    ADD CONSTRAINT "walk_group_members_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."walk_group_messages"
    ADD CONSTRAINT "walk_group_messages_group_id_fkey" FOREIGN KEY ("group_id") REFERENCES "public"."walk_groups"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."walk_group_messages"
    ADD CONSTRAINT "walk_group_messages_sender_id_fkey" FOREIGN KEY ("sender_id") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."walk_groups"
    ADD CONSTRAINT "walk_groups_creator_dog_id_fkey" FOREIGN KEY ("creator_dog_id") REFERENCES "public"."dogs"("id");



ALTER TABLE ONLY "public"."walk_groups"
    ADD CONSTRAINT "walk_groups_creator_id_fkey" FOREIGN KEY ("creator_id") REFERENCES "public"."profiles"("id");



CREATE POLICY "Active dogs are viewable by everyone" ON "public"."dogs" FOR SELECT USING (("is_active" = true));



CREATE POLICY "Anyone can read dog_genders" ON "public"."dog_genders" FOR SELECT USING (true);



CREATE POLICY "Anyone can read dog_sizes" ON "public"."dog_sizes" FOR SELECT USING (true);



CREATE POLICY "Anyone can read health_record_types" ON "public"."health_record_types" FOR SELECT USING (true);



CREATE POLICY "Anyone can read system expense_categories" ON "public"."expense_categories" FOR SELECT USING ((("is_system" = true) OR ("created_by_user_id" = "auth"."uid"())));



CREATE POLICY "Anyone can view active walk groups" ON "public"."walk_groups" FOR SELECT USING (("is_active" = true));



CREATE POLICY "Anyone can view group members" ON "public"."walk_group_members" FOR SELECT USING (true);



CREATE POLICY "Authenticated users can create groups" ON "public"."walk_groups" FOR INSERT WITH CHECK (("auth"."uid"() IS NOT NULL));



CREATE POLICY "Creator can manage own groups" ON "public"."walk_groups" USING (("creator_id" = "auth"."uid"()));



CREATE POLICY "Group members can send messages" ON "public"."walk_group_messages" FOR INSERT WITH CHECK ((("sender_id" = "auth"."uid"()) AND (("group_id" IN ( SELECT "walk_group_members"."group_id"
   FROM "public"."walk_group_members"
  WHERE ("walk_group_members"."user_id" = "auth"."uid"()))) OR ("group_id" IN ( SELECT "walk_groups"."id"
   FROM "public"."walk_groups"
  WHERE ("walk_groups"."creator_id" = "auth"."uid"()))))));



CREATE POLICY "Group members can view messages" ON "public"."walk_group_messages" FOR SELECT USING ((("group_id" IN ( SELECT "walk_group_members"."group_id"
   FROM "public"."walk_group_members"
  WHERE ("walk_group_members"."user_id" = "auth"."uid"()))) OR ("group_id" IN ( SELECT "walk_groups"."id"
   FROM "public"."walk_groups"
  WHERE ("walk_groups"."creator_id" = "auth"."uid"())))));
...
CREATE POLICY "Owners can delete own dogs" ON "public"."dogs" FOR DELETE USING (("auth"."uid"() = "owner_id"));



CREATE POLICY "Owners can delete own dogs' health records" ON "public"."health_records" FOR DELETE USING (("dog_id" IN ( SELECT "dogs"."id"
   FROM "public"."dogs"
  WHERE ("dogs"."owner_id" = "auth"."uid"()))));



CREATE POLICY "Owners can insert health records for own dogs" ON "public"."health_records" FOR INSERT WITH CHECK ((("dog_id" IN ( SELECT "dogs"."id"
   FROM "public"."dogs"
  WHERE ("dogs"."owner_id" = "auth"."uid"()))) AND (("recorded_by_user_id" IS NULL) OR ("recorded_by_user_id" = "auth"."uid"()))));



CREATE POLICY "Owners can insert own dogs" ON "public"."dogs" FOR INSERT WITH CHECK (("auth"."uid"() = "owner_id"));



CREATE POLICY "Owners can update own dogs" ON "public"."dogs" FOR UPDATE USING (("auth"."uid"() = "owner_id"));



CREATE POLICY "Owners can update own dogs' health records" ON "public"."health_records" FOR UPDATE USING (("dog_id" IN ( SELECT "dogs"."id"
   FROM "public"."dogs"
  WHERE ("dogs"."owner_id" = "auth"."uid"())))) WITH CHECK (("dog_id" IN ( SELECT "dogs"."id"
   FROM "public"."dogs"
  WHERE ("dogs"."owner_id" = "auth"."uid"()))));



CREATE POLICY "Owners can view own dogs' health records" ON "public"."health_records" FOR SELECT USING (("dog_id" IN ( SELECT "dogs"."id"
   FROM "public"."dogs"
  WHERE ("dogs"."owner_id" = "auth"."uid"()))));



CREATE POLICY "Payers and dog owners can detach expense_pets" ON "public"."expense_pets" FOR DELETE USING ((("expense_id" IN ( SELECT "dog_expenses"."id"
   FROM "public"."dog_expenses"
  WHERE ("dog_expenses"."paid_by_user_id" = "auth"."uid"()))) OR ("dog_id" IN ( SELECT "dogs"."id"
   FROM "public"."dogs"
  WHERE ("dogs"."owner_id" = "auth"."uid"())))));



CREATE POLICY "Payers can delete contributors" ON "public"."expense_contributors" FOR DELETE USING (("expense_id" IN ( SELECT "dog_expenses"."id"
   FROM "public"."dog_expenses"
  WHERE ("dog_expenses"."paid_by_user_id" = "auth"."uid"()))));



CREATE POLICY "Payers can delete own expenses" ON "public"."dog_expenses" FOR DELETE USING (("paid_by_user_id" = "auth"."uid"()));



CREATE POLICY "Payers can insert contributors" ON "public"."expense_contributors" FOR INSERT WITH CHECK (("expense_id" IN ( SELECT "dog_expenses"."id"
   FROM "public"."dog_expenses"
  WHERE ("dog_expenses"."paid_by_user_id" = "auth"."uid"()))));



CREATE POLICY "Payers can update own expenses" ON "public"."dog_expenses" FOR UPDATE USING (("paid_by_user_id" = "auth"."uid"())) WITH CHECK (("paid_by_user_id" = "auth"."uid"()));



CREATE POLICY "Payers or self can update contributors" ON "public"."expense_contributors" FOR UPDATE USING ((("user_id" = "auth"."uid"()) OR ("expense_id" IN ( SELECT "dog_expenses"."id"
   FROM "public"."dog_expenses"
  WHERE ("dog_expenses"."paid_by_user_id" = "auth"."uid"())))));
...
CREATE POLICY "Users can attach own dogs or own expenses" ON "public"."expense_pets" FOR INSERT WITH CHECK ((("expense_id" IN ( SELECT "dog_expenses"."id"
   FROM "public"."dog_expenses"
  WHERE ("dog_expenses"."paid_by_user_id" = "auth"."uid"()))) OR ("dog_id" IN ( SELECT "dogs"."id"
   FROM "public"."dogs"
  WHERE ("dogs"."owner_id" = "auth"."uid"())))));
...
CREATE POLICY "Users can create matches" ON "public"."matches" FOR INSERT WITH CHECK ((("dog_a_id" IN ( SELECT "dogs"."id"
   FROM "public"."dogs"
  WHERE ("dogs"."owner_id" = "auth"."uid"()))) OR ("dog_b_id" IN ( SELECT "dogs"."id"
   FROM "public"."dogs"
  WHERE ("dogs"."owner_id" = "auth"."uid"())))));



CREATE POLICY "Users can create own expense_categories" ON "public"."expense_categories" FOR INSERT WITH CHECK ((("is_system" = false) AND ("created_by_user_id" = "auth"."uid"())));



CREATE POLICY "Users can create user_matches involving themselves" ON "public"."user_matches" FOR INSERT WITH CHECK ((("auth"."uid"() = "user_a_id") OR ("auth"."uid"() = "user_b_id")));



CREATE POLICY "Users can delete own expense_categories" ON "public"."expense_categories" FOR DELETE USING ((("created_by_user_id" = "auth"."uid"()) AND ("is_system" = false)));



CREATE POLICY "Users can delete own user_matches" ON "public"."user_matches" FOR DELETE USING ((("auth"."uid"() = "user_a_id") OR ("auth"."uid"() = "user_b_id")));



CREATE POLICY "Users can insert own expenses" ON "public"."dog_expenses" FOR INSERT WITH CHECK (("paid_by_user_id" = "auth"."uid"()));
...
CREATE POLICY "Users can insert swipes for own dogs" ON "public"."swipes" FOR INSERT WITH CHECK (("swiper_dog_id" IN ( SELECT "dogs"."id"
   FROM "public"."dogs"
  WHERE ("dogs"."owner_id" = "auth"."uid"()))));



CREATE POLICY "Users can join groups" ON "public"."walk_group_members" FOR INSERT WITH CHECK (("user_id" = "auth"."uid"()));



CREATE POLICY "Users can leave groups" ON "public"."walk_group_members" FOR DELETE USING (("user_id" = "auth"."uid"()));



CREATE POLICY "Users can send messages in their user_matches" ON "public"."messages" FOR INSERT WITH CHECK ((("auth"."uid"() = "sender_id") AND ("user_match_id" IN ( SELECT "user_matches"."id"
   FROM "public"."user_matches"
  WHERE (("user_matches"."user_a_id" = "auth"."uid"()) OR ("user_matches"."user_b_id" = "auth"."uid"()))))));



CREATE POLICY "Users can update own expense_categories" ON "public"."expense_categories" FOR UPDATE USING (("created_by_user_id" = "auth"."uid"())) WITH CHECK ((("created_by_user_id" = "auth"."uid"()) AND ("is_system" = false)));
...
CREATE POLICY "Users can view messages in their user_matches" ON "public"."messages" FOR SELECT USING (("user_match_id" IN ( SELECT "user_matches"."id"
   FROM "public"."user_matches"
  WHERE (("user_matches"."user_a_id" = "auth"."uid"()) OR ("user_matches"."user_b_id" = "auth"."uid"())))));



CREATE POLICY "Users can view own matches" ON "public"."matches" FOR SELECT USING ((("dog_a_id" IN ( SELECT "dogs"."id"
   FROM "public"."dogs"
  WHERE ("dogs"."owner_id" = "auth"."uid"()))) OR ("dog_b_id" IN ( SELECT "dogs"."id"
   FROM "public"."dogs"
  WHERE ("dogs"."owner_id" = "auth"."uid"())))));
...
CREATE POLICY "Users can view own swipes" ON "public"."swipes" FOR SELECT USING (("swiper_dog_id" IN ( SELECT "dogs"."id"
   FROM "public"."dogs"
  WHERE ("dogs"."owner_id" = "auth"."uid"()))));



CREATE POLICY "Users can view own user_matches" ON "public"."user_matches" FOR SELECT USING ((("auth"."uid"() = "user_a_id") OR ("auth"."uid"() = "user_b_id")));



CREATE POLICY "Users can view related contributors" ON "public"."expense_contributors" FOR SELECT USING ((("user_id" = "auth"."uid"()) OR ("expense_id" IN ( SELECT "dog_expenses"."id"
   FROM "public"."dog_expenses"
  WHERE ("dog_expenses"."paid_by_user_id" = "auth"."uid"()))) OR ("expense_id" IN ( SELECT "ep"."expense_id"
   FROM ("public"."expense_pets" "ep"
     JOIN "public"."dogs" "d" ON (("d"."id" = "ep"."dog_id")))
  WHERE ("d"."owner_id" = "auth"."uid"())))));



CREATE POLICY "Users can view related expense_pets" ON "public"."expense_pets" FOR SELECT USING ((("expense_id" IN ( SELECT "dog_expenses"."id"
   FROM "public"."dog_expenses"
  WHERE ("dog_expenses"."paid_by_user_id" = "auth"."uid"()))) OR ("expense_id" IN ( SELECT "expense_contributors"."expense_id"
   FROM "public"."expense_contributors"
  WHERE ("expense_contributors"."user_id" = "auth"."uid"()))) OR ("dog_id" IN ( SELECT "dogs"."id"
   FROM "public"."dogs"
  WHERE ("dogs"."owner_id" = "auth"."uid"())))));



CREATE POLICY "Users can view related expenses" ON "public"."dog_expenses" FOR SELECT USING ((("paid_by_user_id" = "auth"."uid"()) OR ("id" IN ( SELECT "expense_contributors"."expense_id"
   FROM "public"."expense_contributors"
  WHERE ("expense_contributors"."user_id" = "auth"."uid"()))) OR ("id" IN ( SELECT "ep"."expense_id"
   FROM ("public"."expense_pets" "ep"
     JOIN "public"."dogs" "d" ON (("d"."id" = "ep"."dog_id")))
  WHERE ("d"."owner_id" = "auth"."uid"())))));
...
CREATE POLICY "Users can view swipes targeting own dogs" ON "public"."swipes" FOR SELECT USING (("swiped_dog_id" IN ( SELECT "dogs"."id"
   FROM "public"."dogs"
  WHERE ("dogs"."owner_id" = "auth"."uid"()))));



ALTER TABLE "public"."dog_expenses" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."dog_genders" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."dog_sizes" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."health_record_types" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."walk_group_messages" ENABLE ROW LEVEL SECURITY;
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."walk_group_messages";
...
GRANT ALL ON FUNCTION "public"."ensure_user_match"("p_user_a" "uuid", "p_user_b" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."ensure_user_match"("p_user_a" "uuid", "p_user_b" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."ensure_user_match"("p_user_a" "uuid", "p_user_b" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_nearby_dogs"("user_lat" double precision, "user_lng" double precision, "radius_km" double precision) TO "anon";
GRANT ALL ON FUNCTION "public"."get_nearby_dogs"("user_lat" double precision, "user_lng" double precision, "radius_km" double precision) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_nearby_dogs"("user_lat" double precision, "user_lng" double precision, "radius_km" double precision) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_upcoming_health_reminders"("p_user_id" "uuid", "p_within_days" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_upcoming_health_reminders"("p_user_id" "uuid", "p_within_days" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_upcoming_health_reminders"("p_user_id" "uuid", "p_within_days" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."matches_ensure_user_match"() TO "anon";
GRANT ALL ON FUNCTION "public"."matches_ensure_user_match"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."matches_ensure_user_match"() TO "service_role";



GRANT ALL ON FUNCTION "public"."messages_fill_user_match_id"() TO "anon";
GRANT ALL ON FUNCTION "public"."messages_fill_user_match_id"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."messages_fill_user_match_id"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_user_location_by_id"("user_id" "uuid", "lat" double precision, "lng" double precision) TO "anon";
GRANT ALL ON FUNCTION "public"."update_user_location_by_id"("user_id" "uuid", "lat" double precision, "lng" double precision) TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_user_location_by_id"("user_id" "uuid", "lat" double precision, "lng" double precision) TO "service_role";
...
GRANT ALL ON TABLE "public"."dog_expenses" TO "anon";
GRANT ALL ON TABLE "public"."dog_expenses" TO "authenticated";
GRANT ALL ON TABLE "public"."dog_expenses" TO "service_role";



GRANT ALL ON TABLE "public"."dog_genders" TO "anon";
GRANT ALL ON TABLE "public"."dog_genders" TO "authenticated";
GRANT ALL ON TABLE "public"."dog_genders" TO "service_role";



GRANT ALL ON TABLE "public"."dog_sizes" TO "anon";
GRANT ALL ON TABLE "public"."dog_sizes" TO "authenticated";
GRANT ALL ON TABLE "public"."dog_sizes" TO "service_role";
...
GRANT ALL ON TABLE "public"."expense_contributors" TO "anon";
GRANT ALL ON TABLE "public"."expense_contributors" TO "authenticated";
GRANT ALL ON TABLE "public"."expense_contributors" TO "service_role";



GRANT ALL ON TABLE "public"."expense_pets" TO "anon";
GRANT ALL ON TABLE "public"."expense_pets" TO "authenticated";
GRANT ALL ON TABLE "public"."expense_pets" TO "service_role";



GRANT ALL ON TABLE "public"."health_record_types" TO "anon";
GRANT ALL ON TABLE "public"."health_record_types" TO "authenticated";
GRANT ALL ON TABLE "public"."health_record_types" TO "service_role";
...
GRANT ALL ON TABLE "public"."walk_group_members" TO "anon";
GRANT ALL ON TABLE "public"."walk_group_members" TO "authenticated";
GRANT ALL ON TABLE "public"."walk_group_members" TO "service_role";



GRANT ALL ON TABLE "public"."walk_group_messages" TO "anon";
GRANT ALL ON TABLE "public"."walk_group_messages" TO "authenticated";
GRANT ALL ON TABLE "public"."walk_group_messages" TO "service_role";



GRANT ALL ON TABLE "public"."walk_groups" TO "anon";
GRANT ALL ON TABLE "public"."walk_groups" TO "authenticated";
GRANT ALL ON TABLE "public"."walk_groups" TO "service_role";
